...
// Mime types safe to render inline in the browser for previewing. Deliberately
// excludes anything that can carry active content (svg, html, xml, ...) so a
// malicious upload can never execute in the app's own origin.
